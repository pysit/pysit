...
__all__ = ['DerivativeGaussianPulse', 'RickerWavelet', 'GaussianPulse', 'WhiteNoiseSource']
...
class SourceWaveletBase(object):
	...
	@property
	def time_source(self): return False
	
	@property
	def frequency_source(self): return False
