...
"""
This package contains the sphinx extensions used by PySIT.

Currently, extensions from Astropy and cloud_sptheme are provided.

These packages should be kept up to date with:
