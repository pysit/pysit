...
__all__ = ['VariableDensityAcousticTimeODEBase']
...
class _VariableDensityAcousticTimeODE_SolverData(SolverDataTimeBase):
...
class VariableDensityAcousticTimeODEBase(VariableDensityAcousticTimeBase):
    ...
    def __init__(self,
        ...
        VariableDensityAcousticTimeBase.__init__(self,
                                                 mesh,
                                                 temporal_integrator='rk',
    ...
    _SolverData = _VariableDensityAcousticTimeODE_SolverData
